...
@tc_01
Scenario: Log in to OrangeHRM with valid Cradentials
...
@tc_02
Scenario: Log in to OrangeHRM with invalid Cradentials
...
@tc_03
Scenario: To check if the dashboard page is present when user log into the website
...
@tc_04
Scenario: To check the footer of the dash borad contains OrangeHRM
...
@tc_05
Scenario: Leave link is working in properly or not in the dashborad page 
